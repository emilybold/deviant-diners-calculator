...
function convertToEmoji(result) {
    ...
    const customEmojis = {
        ...
        '351': 'iterative pizza',
        '352': 'griddled vasectomy',
        '353': 'slow roasted bassoon',
        '354': 'pork violins',
        '355': 'honey glazed artillery',
        '356': 'cannelloni gone septic',
        '357': 'truffled peonies',
        '358': 'sardonic biscotti',
        '359': 'fruity galumph',

        '360': 'rotated cactus chips',
        '361': 'cementine clementine',
        '362': 'haddock on the inside',
        '363': 'cantankerous roulade',
        '364': 'banana stool',
        '365': 'pecan subterfuge',
        '366': 'custard vicarage',
        '367': 'barbershop profiteroles',
        '368': 'white chocolate burlap',
        '369': 'allegen loaf',
      
        '370': 'incontinental breakfast',
        '371': 'bao bun bonanza',
        '372': 'slug with poppy seeds',
        '373': 'strawberry mollusk',
        '374': 'leggy bread',
        '375': 'blueberry pipeline',
        '376': 'flannel granita',
        '377': 'pub lunch',
        '378': 'sourdough bathtime',
        '379': 'sugared moss',

        '380': 'funeral platter',
        '381': 'kefir chinwag',
        '382': 'gangrenous mushrooms',
        '383': 'sweetened condensed lymph',
        '384': 'milky lubricant',
        '385': 'puff pastry vessels',
        '386': 'wholegrain vestibule',
        '387': 'halloumi grimace',
